...
import { MasterLayout, PerformanceTable } from "../../../components";
import { Link, useNavigate } from "react-router-dom";
import { useQuery } from "@tanstack/react-query";
import { getPerformance } from "../../../hooks/usePerformance";
...
function Performance() {
  ...
  const { data } = useQuery({
    queryKey: ["performance", { bulan, tahun }],
    queryFn: async () => await getPerformance({ bulan, tahun }),
  });
